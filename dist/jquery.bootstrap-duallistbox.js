...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      iconsPrefix: 'fa',                                                                  // string, allows user to set the icon font specific prefix (e.g. "fa", "glyphicon", etc.)
      icons: {                                                                            // object, allows user to set the icon clas for move and remove operations
          move: 'fa-chevron-right',
